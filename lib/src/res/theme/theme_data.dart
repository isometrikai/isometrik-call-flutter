...
class IsmCallThemeData {
  const IsmCallThemeData({
  ...
  IsmCallThemeData lerp(covariant IsmCallThemeData? other, double t) {
    if (other is! IsmCallThemeData) {
      return this;
    }
    return IsmCallThemeData(
