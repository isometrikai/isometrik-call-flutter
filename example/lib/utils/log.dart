...
class CallLog {
  ...
  CallLog(this.message, [this.stackTrace]) {
    log(
  ...
  ///- `AppLog.success()` - for success log
  CallLog.error(this.message, [this.stackTrace]) {
    log(
  ...
  ///- `AppLog.info()` - for info log
  ///- `AppLog.error()` - for error log
  CallLog.success(this.message, [this.stackTrace]) {
    log(
  ...
  ///- `AppLog.success()` - for success log
  ///- `AppLog.error()` - for error log
  CallLog.info(this.message, [this.stackTrace]) {
    log(
  ...
  ///- `AppLog.success()` - for success log
  ///- `AppLog.error()` - for error log
  CallLog.highlight(this.message, [this.stackTrace]) {
    log(
